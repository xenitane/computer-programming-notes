So far we have seen decision making through [[conditionality.md|if/else]] but is there an other efficient way of doing this when we only have to check for the value of a single value/expression. 
